...
class DataModel {
    ...
    createRecipe = async(category,contents,image_url,ingredients,time,title,userID) => {
    ...
    updateRecipe = async (recipeKey, category, contents, image_url, ingredients, time, title, userID) => {
        let Recipe={
            category:category,
            content:contents,
            image_url:image_url,
